...
export default {
  ...
  methods: {
    showRow: function (row) {
      ...
      row.row._show = show;
      return show ? "animation:treeTableShow 0s;-webkit-animation:treeTableShow 0s;" : "display:none;";
    },
    // 切换下级是否展开
    ...
    toselect(row) {
      ...
      if (this.tableChcekedList.length === 0 && row._level === 2 && row.checks) {
        // console.log("数组长度为0的时候 触发");
